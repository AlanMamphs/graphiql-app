...
export const Root = ({
  ...
  <Tabs.Root
    className={cn('flex flex-col shadow-md w-full', className)}
    {...restProps}
  >
    {children}
  </Tabs.Root>
